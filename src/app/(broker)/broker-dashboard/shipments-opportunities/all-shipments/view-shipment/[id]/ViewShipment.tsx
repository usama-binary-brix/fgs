            ...
            <div className="row mb-5">
                <div className="col-span-12">
                    <div className='bg-white p-3 rounded'>
                        <h1 className='text-[#414141] text-[27px] font-extrabold font-family'>S-{shipment.id}</h1>
            ...
            <div className="row">
                <div className='grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 gap-4'>
                    ...
                    <div className="bg-white w-full rounded p-3 h-[365px]">
                        ...
                        <div className='col-span-1 mb-3'>
                            <label className="text-[12.5px] text-[#818181] font-normal font-family">Country/Region <span className='text-red-500'>*</span></label>
                            <input
                                disabled
                        ...
                        <div className="bg-white w-full h-[135px] rounded p-3">
                            ...
                            <div className='col-span-1 mb-3 flex flex-col gap-2'>
                                ...
                                <textarea 
                                    ...
                                    className='border-1 text-[13px] border-[#e8e8e8] rounded-xs text-[#414141] font-family font-medium'
                                />
                            </div>
                        </div>
