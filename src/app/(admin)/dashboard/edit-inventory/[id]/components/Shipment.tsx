          ...
          {activeTab === "details" && (
            <>
              ...
              {activeBoundTab === "inbound" && (
                <>
                  <div className='bg-[#F7F7F7] p-3 gap-2 hidden mt-5 rounded-lg  justify-center flex-col items-center'>
                  ...
                  <div>
                    <Accordion>
                      <AccordionSummary
                        ...
                        id="panel1-header"
                      >
                        <Typography className='text-[17px] text-[#000] font-medium font-family' component="span">Inbound Shipment # 001</Typography>
                      </AccordionSummary>
                      <AccordionDetails>
                        <Typography>
