  ...
  >
    <path d="M12 12c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm0 2c-3.33 0-10 1.67-10 5v3h20v-3c0-3.33-6.67-5-10-5z" />
        ...
        {/* <div className="max-w-[1rem]">
          ...
          <p className="text-[11px] text-[#fff] opacity-[70%] font-normal font-family max-w-[2px]">{user?.email}</p>
        </div> */}

<div className="max-w-[110px] overflow-hidden">
  <p className="text-[13px] capitalize font-normal font-family mb-[1.5px] truncate">{user?.first_name} {user?.last_name}</p>
  <p className="text-[11px] text-[#fff] opacity-[70%] font-normal font-family truncate">{user?.email}</p>
</div>
      </div>
